...
public class OneVOneReset : BasePlugin
{
    ...
    private void OnGsCommand(CCSPlayerController? player, CommandInfo info)
    {
        ...
        player.PrintToChat($" -----------------------------------------------------------------");
        player.PrintToChat($" [ {ChatColors.Blue}手槍{ChatColors.White} ]  {ChatColors.Blue}!dg {ChatColors.White}[ 沙鷹 ]     、 {ChatColors.Blue}!usp {ChatColors.White}[ USP ]     、 {ChatColors.Blue}!gk {ChatColors.White}[ 格洛克 ]     、 {ChatColors.Blue}!r8 {ChatColors.White}[ R 8 ]");
